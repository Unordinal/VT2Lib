...
public sealed class BundleOld : IDisposable
{
    ...
    /// </summary>
    public ImmutableArray<ResourceLocator> ResourceList { get; private set; }
    ...
    private BundleOld(BundleVersion version, long size, bool isCompressed, Stream bundleStream, IIDString64Provider? idStringProvider = null)
    {
    ...
    /// <summary>
    /// Gets a new bundle representing this bundle with the given patch bundles applied.
    /// </summary>
    /// <param name="patchBundles"></param>
    /// <returns></returns>
    public BundleOld WithPatches(params BundleOld[] patchBundles)
    {
    ...
    public static BundleOld Open(Stream stream, IIDString64Provider? idStringProvider = null)
    {
    ...
    public static BundleOld Open(Stream stream, bool isCompressed, IIDString64Provider? idStringProvider = null)
    {
        ArgumentNullException.ThrowIfNull(stream);
        ...
        return new BundleOld(version, size, isCompressed, stream, idStringProvider);
    }
}